...
- Use plain, functional page and section headings. Do not add editorial slogans, motivational taglines, or redundant eyebrow headers; preserve factual stage names, ride keys, climb labels, packing tasks, and privacy guidance.
- Attribute each stage's overview, route summary, and effort/pacing notes beside the text, with a link to the actual source. Distinguish Codex-authored summaries and pacing suggestions from official quotations or coaching; never label them as rider-roadbook excerpts unless that document was actually used.
